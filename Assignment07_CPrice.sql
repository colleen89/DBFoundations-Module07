...
-- 2023-11-27,Colleen Price,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_ColleenPrice')
	 Begin 
	  Alter Database [Assignment07DB_ColleenPrice] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_ColleenPrice;
	 End
	Create Database Assignment07DB_ColleenPrice;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_ColleenPrice;
...
Select c.CategoryName, 
	   p.ProductName, 
	   '$' + Cast(p.UnitPrice as varchar(10))
From vCategories As c
Join vProducts As p
 On c.CategoryID = p.CategoryID
Order By 1,2,3;
...
--Select InventoryDate, InventoryCount, [PreviousMonthCount] = IIF(InventoryDate Like ('January%'), 0, IsNull(Lag(InventoryCount) Over (Order By ProductName,Year(InventoryDate)), 0) 
...
--Select * From vInventories;
--Select ProductName From vProducts;
--Select InventoryDate, InventoryCount, [PreviousMonthCount], [CountVsPreviousCountKPI] 
--From vProductInventoriesWithPreviousMonthCounts;
--Select InventoryDate, InventoryCount, [PreviousMonthCount], [CountVsPreviousCountKPI] = IsNull(Case
...
--Select * From vInventories;
--Select ProductName From vProducts;
--Select InventoryDate, Count, [PreviousMonthCount], [CountVsPreviousCountKPI] From vInventories;
